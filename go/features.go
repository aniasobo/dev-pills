// minimal working examples of Go features
// all credit to github.com/Mathieu-Desrochers
// taken from https://github.com/Mathieu-Desrochers/Learning-Go/blob/master/main.go
